      ...
      <View style={styles.contenedor}>
        ...
        <View>
          <TouchableHighlight onPress={() => mostrarFormulario()}
            ...
            <Text style={styles.textoMostrarForm}> {mostrarform ? 'Cancelar Reservación' : 'Crear Reservación'} </Text>
          </TouchableHighlight>
        </View>
        <View style={styles.contenido}>
          {mostrarform ? (
            ...
            <>
              <Text style={styles.titulo}> {citas.length > 0 ? 'Administra reservaciones' :
